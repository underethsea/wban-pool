    ...
    try {
      ...
      if (balances[0].TICKET.lt(ethers.BigNumber.from(ethers.utils.parseUnits(inputAmount,18)))) {
        ...
        if (!rngStatus) {
          ...
          if(exitFee > 0 && okToWithdraw === false) {setWalletMessage("FEE " + NumberChop(exitFee) + " wBAN");setWithdrawButton("OK WITHDRAW WITH FEE")}
                          ...
                          <span className="top-title">
                            ...
                            {!isNaN(poolInfo.prizepool) && (
                                poolInfo.prizepool -
                                  ...
                                  <span><small>No prize</small></span> : <span>                         
                            ...
                            <table className="wallet-table top-padded">
                              ...
                              {isConnected &&
                                balances[0].TOKEN.gt(BNZERO) && (
                                  <tr>
                                    <td>
                                      <span className="token-text">wBAN</span>
                                    </td>
